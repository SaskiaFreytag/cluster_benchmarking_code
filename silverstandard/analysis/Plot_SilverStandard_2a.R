...
#                                                                                         #
#                                                                                         #
#                           Make Figure Silver Standard 2a                                #
#                                                                                         #
#                                                                                         #
###########################################################################################
...
programs <- c( "ascend", "Cell Ranger", "CIDR", "countClust", "RaceID", "RaceID2", "RCA", "SC3", "scran", "Seurat","SIMLR","TSCAN")         
...
pdf("Plot_SilverStandard_2a.pdf", width=10.45, height=10.45)
plot_corr_sim(mat1_cellranger, clust_num_cellranger)
text("a", x=-1, y=12.5, cex=2.5)
dev.off()
