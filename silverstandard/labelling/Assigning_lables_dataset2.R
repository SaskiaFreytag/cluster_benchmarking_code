...
#                                                                                         #
#                                                                                         #
#                     ASSIGNING CLUSTER NAMES VIA 10X METHOD DATASET2                     #
#                                                                                         #
#                                                                                         #
###########################################################################################
...
save(assigned_cell_types, file="Assigned_Cell_Types_Dataset2.RData")

csl_id1<-cbind(colnames(z_1000_11)[test], z_1000_11[cbind(1:length(test), test)])
save(csl_id1, file="Assigned_Cell_Types_Info_Dataset2.RData")
