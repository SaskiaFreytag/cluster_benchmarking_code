...
gene_bc_matrix <- load_cellranger_matrix("dataset3")
...
write.csv(barcode, file="cleaned_barcodes_dataset3.csv", row.names = F, quote=F)

## Save scater object for further analysis
save(sce, file="Sce_Dataset3.RData")
