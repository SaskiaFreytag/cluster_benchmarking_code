...
gene_bc_matrix <- load_cellranger_matrix("dataset2")
...
write.csv(barcode, file="cleaned_barcodes_dataset2.csv", row.names = F, quote=F)

## Save scater object for further analysis
save(sce, file="Sce_Dataset2.RData")
