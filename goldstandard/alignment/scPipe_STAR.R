...
exon_annotation = "GRCh38_v90/Homo_sapiens.GRCh38.90.gff3"
# you can find the annotation on: ftp://ftp.ensembl.org/pub/release-90/gff3/

## cell barcode annotation
barcode_annotation_file = "barcode_annotation_scpipe_star.csv"
## genome index, depends on which alinger you use. 
genome_index = "GRCh38_v90/Homo_sapiens_GR38_90_primary_index"
...
# output folder
data_dir = "scpipe/STAR"
system("mkdir scpipe/STAR")
## output files:
combined_fastq = file.path(data_dir, "../combined.fastq")
aligned_bam = file.path(data_dir, "Aligned.sortedByCoord.out.bam")
mapped_bam = file.path(data_dir, "Aligned.sortedByCoord.out.mapped.bam")
